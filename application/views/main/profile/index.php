            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <?php foreach($redes as $red): ?>
                  <li><i class="fab fa-facebook-f"></i> <?php echo $red->user_facebook ?></li>
                  <li><i class="fab fa-instagram"></i> <?php echo $red->user_instagram ?></li>
                  <li><i class="fab fa-twitter"></i> <?php echo $red->user_twitter ?></li>
                  <li><i class="fab fa-twitch"></i> <?php echo $red->user_twitch ?></li>
                <?php endforeach ?>
