                      ...
                      <tbody>
                        <?php if($teams != NULL): ?>
                            ...
                            <tr>
                              ...
                              <td><?= $team->nombre?></td>
                              <td>
                                <button type="button" class="btn btn-tool"><a href="<?=base_url('admin/team/edit/'.$team->id)?>"><i class="fas fa-edit"></i></a>
                                </button>
                                <button type="button" class="btn btn-tool"><a href="<?=base_url('admin/team/delete/'.$team->id)?>" onclick="return confirm('¿Estas seguro de eliminar?')"><i class="fas fa-trash-alt"></i></a>
                                </button>
                              </td>
                            </tr> 
                            <?php endforeach ?>
